...
class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        vehicle.add(this.scene, 'speedFactor', 0.1, 3).name('Speed Factor').onChange(this.scene.updateSpeed.bind(this.scene));
        vehicle.add(this.scene, 'scaleFactor', 0.5, 3).name('Scale Factor');
        vehicle.add(this.scene.vehicle.flag, 'selectedFlagTexture', this.scene.vehicle.flag.texturesFlagIds).name('Selected Texture');
